...
function rc_rating_scripts() { 
    wp_enqueue_style( 'rating-css', plugin_dir_url( __FILE__ ) . '<public><css>rating-public.css', array(), '', 'screen' );
    wp_register_script( 'rating-js', plugin_dir_url( __FILE__ ) . '<public><js>rating-public.js', array('jquery'), '', true );
